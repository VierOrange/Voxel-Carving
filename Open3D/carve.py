...
def carve_sides(dir, param_file, angle_file, output_file):
	'''
	...
	o3d.io.write_voxel_grid(output_file, voxel_grid, write_ascii=True, compressed=False, print_progress=True)

carve_sides('./temple/','./temple/temple_par.txt', './temple/temple_ang.txt', './temple/output.ply')
